...
import {
  getAgeScore, getAnnualIncomeScore, getAnnuityAmountScore, getCreditAmountScore, getDaysEmployedScore, getEducationScore, getExternalSource2Score,
  getFamilySizeScore, getFamilyStatusScore, getHousingTypeScore, getIncomeTypeScore, getLoanTypeScore, getOccupationScore, getOwnsCarScore, getSocialCircleScore
} from './scoring'
